...
const MOCK_NOTIFICATIONS: Notification[] = [
    ...
    { id: '6', type: 'system', title: '📊 Weekly Progress Report', message: 'You solved 12 problems, improved your SkillTen Score by 5 points, and maintained a 12-day streak. Great week!', time: '3 days ago', read: true, icon: '📊' },
    { id: '7', type: 'achievement', title: '⭐ Score Milestone', message: 'Your SkillTen Score™ crossed 50! You earned the "Rising Star" badge.', time: '4 days ago', read: true, action_url: '/score', icon: '⭐' },
