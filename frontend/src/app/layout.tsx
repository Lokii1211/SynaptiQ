...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="antialiased" suppressHydrationWarning style={{ fontFamily: "'Inter', system-ui, -apple-system, sans-serif", '--font-heading': "'Outfit', 'Inter', system-ui, sans-serif" } as React.CSSProperties}>
        <LanguageProvider>
          {children}
          <NotificationToast />
        </LanguageProvider>
