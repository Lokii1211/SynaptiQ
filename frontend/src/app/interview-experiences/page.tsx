...
const MOCK_EXPERIENCES: InterviewExp[] = [
    {
        ...
        outcome: 'selected', ctc: '3.6 LPA', viyaScore: 68,
        rounds: [
    ...
    },
    {
        ...
        outcome: 'selected', ctc: '3.6 LPA', viyaScore: 72,
        rounds: [
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-3 text-[10px] text-slate-400 flex-wrap">
                                                        ...
                                                        {exp.viyaScore && <span className="font-bold text-indigo-600">⭐ Viya: {exp.viyaScore}</span>}
                                                    </div>
