...
CAREERS = [
    {
        ...
        "related_courses": ["B.Tech CS", "BCA", "Full Stack Bootcamp", "NPTEL Programming"],
        "icon": "💻"
    },
    {
        ...
        "related_courses": ["M.Tech AI/ML", "Google Data Analytics", "Andrew Ng ML Course"],
        "icon": "📊"
    },
    {
        ...
        "day_in_life": "Start with metrics review — how are users engaging? Sprint planning with engineers. Lunch meeting with design team on upcoming features. Afternoon: user interviews, competitive analysis, writing PRDs. End of day: stakeholder alignment and roadmap review.",
        ...
        "related_courses": ["MBA", "ISB YLP", "Product School Certification"],
        "icon": "🎯"
    },
    {
        ...
        "day_in_life": "Morning: review user feedback and analytics. Design wireframes for a new feature in Figma. Afternoon: conduct usability testing with real users, iterate on designs. Collaborate with developers on implementation. Evening: study design trends, update design system.",
        ...
        "related_courses": ["B.Des Interaction Design", "Google UX Certificate", "IDF UX Course"],
        "icon": "🎨"
    },
    {
        ...
        "day_in_life": "Review financial statements and audit reports. Meeting with clients on tax planning strategies. Afternoon: analyze complex financial transactions, prepare compliance reports. Filing season means long hours ensuring accuracy in tax returns.",
        "required_skills": ["Accounting", "Taxation", "Auditing", "Financial Analysis", "Indian GAAP/Ind AS", "MS Excel", "Tally"],
        "required_education": [{"degree": "CA Foundation + Inter + Final", "field": "Chartered Accountancy", "duration": "4-5 years"}, {"degree": "B.Com + CA", "field": "Commerce + CA", "duration": "3+4 years"}],
        "salary_range_min": 600000,
        ...
        "related_courses": ["B.Com", "CA Articleship", "ACCA"],
        "icon": "📈"
    },
    {
        ...
        "day_in_life": "Check campaign metrics first thing — clicks, conversions, ROAS. Create content for social media. Optimize Google Ads campaigns. Afternoon: SEO audit of website, keyword research. Brainstorm creative campaigns with the team. Analyze competitor strategies.",
        ...
        "related_courses": ["Google Digital Marketing Certificate", "HubSpot Academy", "MBA Marketing"],
        "icon": "📱"
    },
    {
        ...
        "day_in_life": "Review CAD designs and run simulations. Visit the manufacturing floor to check prototype assembly. Afternoon: FEA analysis on a component, meeting with quality team. Coordinate with suppliers on material specifications. Documentation and design review.",
        ...
        "required_education": [{"degree": "B.Tech/BE", "field": "Mechanical Engineering", "duration": "4 years"}, {"degree": "Diploma + B.Tech", "field": "Mechanical", "duration": "3+3 years"}],
        ...
        "related_courses": ["B.Tech Mechanical", "NPTEL Courses", "SolidWorks Certification"],
        "icon": "⚙️"
    },
    {
        "title": "Doctor (MBBS)",
        "slug": "doctor-mbbs",
        "category": "healthcare",
        "description": "Diagnose illnesses, prescribe treatments, and care for patients' health. Doctors play a critical role in society, combining deep medical knowledge with compassion and decision-making under pressure.",
        "day_in_life": "Morning rounds checking on admitted patients. OPD hours seeing patients, diagnosing conditions. Afternoon: procedures or surgeries depending on specialization. Review lab reports. Emergency cases can arise anytime. CME and case study discussions with peers.",
        ...
        "growth_outlook": "high",
        "demand_score": 90,
        "top_companies": ["AIIMS", "Apollo", "Fortis", "Max Healthcare", "Manipal Hospitals", "Government Hospitals"],
        "entrance_exams": ["NEET UG", "NEET PG", "AIIMS"],
        "related_courses": ["MBBS", "MD/MS", "DNB"],
        "icon": "🩺"
    },
    {
        ...
        "slug": "civil-services",
        "category": "government",
        "description": "Serve the nation at the highest levels of government administration. Civil servants lead policy implementation, governance, and public welfare at district, state, and national levels.",
        "day_in_life": "Review government circulars and policy briefs. Meet with department heads on ongoing projects. Field visit to inspect development work. Afternoon: public grievance hearings, decision-making on approvals. Evening: read files, prepare reports for senior officials.",
        "required_skills": ["Administrative Skills", "Public Policy", "Leadership", "Decision Making", "Ethics", "Communication", "General Knowledge"],
        "required_education": [{"degree": "Any Graduation", "field": "Any discipline", "duration": "3-4 years"}, {"degree": "Graduation + UPSC Prep", "field": "With coaching/self-study", "duration": "4-6 years"}],
        "salary_range_min": 800000,
        "salary_range_max": 2500000,
        "growth_outlook": "medium",
        "demand_score": 88,
        ...
        "related_courses": ["UPSC Coaching", "Optional Subject Deep Study", "Current Affairs"],
        "icon": "🏛️"
    },
    {
        ...
        "day_in_life": "Morning: review model training metrics from overnight runs. Prepare and clean datasets. Afternoon: experiment with new model architectures, fine-tune hyperparameters. Deploy a model to production. Collaborate with data engineers on pipelines. Read latest research papers.",
        ...
        "growth_outlook": "high",
        "demand_score": 96,
        "top_companies": ["Google DeepMind", "OpenAI", "Microsoft", "NVIDIA", "Amazon", "Meta", "Reliance Jio"],
        "entrance_exams": ["JEE", "GATE", "GRE"],
        "related_courses": ["M.Tech AI", "Stanford CS229", "Fast.ai", "DeepLearning.AI"],
        "icon": "🤖"
    },
    {
        ...
        "day_in_life": "Morning briefing on new project requirements. Create mood boards and initial concepts. Design social media posts and banners. Afternoon: work on brand identity project, present logo options to client. Revise designs based on feedback. End of day: export final files for print/digital.",
        "required_skills": ["Adobe Photoshop", "Illustrator", "Typography", "Color Theory", "Brand Design", "Layout Design", "Canva"],
        "required_education": [{"degree": "B.Des/BFA", "field": "Graphic/Visual Design", "duration": "4 years"}, {"degree": "Any degree", "field": "With design portfolio", "duration": "3-4 years"}],
        ...
        "related_courses": ["B.Des Visual Communication", "Adobe Certified", "Coursera Graphic Design"],
        "icon": "✏️"
    },
    {
        ...
        "category": "technology",
        "description": "Protect organizations from cyber threats by monitoring systems, investigating incidents, and implementing security controls. A critical role as digital threats grow.",
        "day_in_life": "Monitor SIEM dashboard for security alerts. Investigate a phishing attempt targeting employees. Perform vulnerability assessment on new application. Afternoon: update firewall rules, review access logs. Conduct security awareness training. Document incident reports.",
        ...
        "required_education": [{"degree": "B.Tech", "field": "CS/IT/Cybersecurity", "duration": "4 years"}, {"degree": "Any IT degree", "field": "With security certifications", "duration": "3-4 years"}],
        "salary_range_min": 500000,
        "salary_range_max": 2500000,
        "growth_outlook": "high",
        "demand_score": 88,
        "top_companies": ["Palo Alto Networks", "CrowdStrike", "TCS", "Wipro", "KPMG", "Deloitte", "CERT-In"],
        "entrance_exams": ["JEE Main", "GATE"],
        "related_courses": ["CEH", "CompTIA Security+", "OSCP", "B.Tech Cybersecurity"],
        "icon": "🔐"
    }
]
...
ASSESSMENT_QUESTIONS = [
    ...
    {
        "id": 4,
        "question": "When you achieve a goal, what matters most to you?",
        "category": "values",
        "options": [
    ...
    {
        "id": 8,
        "question": "Which of these challenges appeals to you?",
        "category": "interests",
        "options": [
    ...
    {
        "id": 10,
        "question": "If money wasn't a concern, you would:",
        "category": "passion",
        "options": [
    ...
    {
        "id": 15,
        "question": "When faced with ambiguity, you:",
